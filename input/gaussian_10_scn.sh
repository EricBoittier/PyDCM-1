...
export INPFILE=gaussian_10_scn.com
export OUTFILE=gaussian_10_scn.out
export CHKFILE=gaussian_10_scn.chk
export FCKFILE=gaussian_10_scn.fchk
export DNSFILE=gaussian_10_scn_dens.cube
export ESPFILE=gaussian_10_scn_esp.cube
