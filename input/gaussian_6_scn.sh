...
export INPFILE=gaussian_6_scn.com
export OUTFILE=gaussian_6_scn.out
export CHKFILE=gaussian_6_scn.chk
export FCKFILE=gaussian_6_scn.fchk
export DNSFILE=gaussian_6_scn_dens.cube
export ESPFILE=gaussian_6_scn_esp.cube
