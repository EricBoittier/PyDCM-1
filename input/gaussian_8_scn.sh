...
export INPFILE=gaussian_8_scn.com
export OUTFILE=gaussian_8_scn.out
export CHKFILE=gaussian_8_scn.chk
export FCKFILE=gaussian_8_scn.fchk
export DNSFILE=gaussian_8_scn_dens.cube
export ESPFILE=gaussian_8_scn_esp.cube
