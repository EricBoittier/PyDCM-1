...
export INPFILE=gaussian_12_scn.com
export OUTFILE=gaussian_12_scn.out
export CHKFILE=gaussian_12_scn.chk
export FCKFILE=gaussian_12_scn.fchk
export DNSFILE=gaussian_12_scn_dens.cube
export ESPFILE=gaussian_12_scn_esp.cube
