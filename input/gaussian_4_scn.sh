...
export INPFILE=gaussian_4_scn.com
export OUTFILE=gaussian_4_scn.out
export CHKFILE=gaussian_4_scn.chk
export FCKFILE=gaussian_4_scn.fchk
export DNSFILE=gaussian_4_scn_dens.cube
export ESPFILE=gaussian_4_scn_esp.cube
