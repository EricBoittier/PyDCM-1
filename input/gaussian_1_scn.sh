...
export INPFILE=gaussian_1_scn.com
export OUTFILE=gaussian_1_scn.out
export CHKFILE=gaussian_1_scn.chk
export FCKFILE=gaussian_1_scn.fchk
export DNSFILE=gaussian_1_scn_dens.cube
export ESPFILE=gaussian_1_scn_esp.cube
