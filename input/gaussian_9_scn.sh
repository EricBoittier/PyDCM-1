...
export INPFILE=gaussian_9_scn.com
export OUTFILE=gaussian_9_scn.out
export CHKFILE=gaussian_9_scn.chk
export FCKFILE=gaussian_9_scn.fchk
export DNSFILE=gaussian_9_scn_dens.cube
export ESPFILE=gaussian_9_scn_esp.cube
