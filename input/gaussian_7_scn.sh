...
export INPFILE=gaussian_7_scn.com
export OUTFILE=gaussian_7_scn.out
export CHKFILE=gaussian_7_scn.chk
export FCKFILE=gaussian_7_scn.fchk
export DNSFILE=gaussian_7_scn_dens.cube
export ESPFILE=gaussian_7_scn_esp.cube
