...
export INPFILE=gaussian_5_scn.com
export OUTFILE=gaussian_5_scn.out
export CHKFILE=gaussian_5_scn.chk
export FCKFILE=gaussian_5_scn.fchk
export DNSFILE=gaussian_5_scn_dens.cube
export ESPFILE=gaussian_5_scn_esp.cube
