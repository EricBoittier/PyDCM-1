...
export INPFILE=gaussian_3_scn.com
export OUTFILE=gaussian_3_scn.out
export CHKFILE=gaussian_3_scn.chk
export FCKFILE=gaussian_3_scn.fchk
export DNSFILE=gaussian_3_scn_dens.cube
export ESPFILE=gaussian_3_scn_esp.cube
