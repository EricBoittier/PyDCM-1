...
export INPFILE=gaussian_11_scn.com
export OUTFILE=gaussian_11_scn.out
export CHKFILE=gaussian_11_scn.chk
export FCKFILE=gaussian_11_scn.fchk
export DNSFILE=gaussian_11_scn_dens.cube
export ESPFILE=gaussian_11_scn_esp.cube
