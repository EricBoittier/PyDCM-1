...
export INPFILE=gaussian_0_scn.com
export OUTFILE=gaussian_0_scn.out
export CHKFILE=gaussian_0_scn.chk
export FCKFILE=gaussian_0_scn.fchk
export DNSFILE=gaussian_0_scn_dens.cube
export ESPFILE=gaussian_0_scn_esp.cube
